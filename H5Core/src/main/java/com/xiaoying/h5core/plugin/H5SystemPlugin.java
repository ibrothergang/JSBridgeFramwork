...
public class H5SystemPlugin implements H5Plugin {
    ...
    private void openInBrowser(H5Intent intent) throws JSONException {
    ...
    private void installedApp(H5Intent intent) throws JSONException {
        JSONObject param = intent.getParam();
    ...
    private void sendSms(H5Intent intent) throws JSONException {
    ...
    private void checkJsAPI(H5Intent intent) throws JSONException {
        JSONObject param = intent.getParam();
    ...
    private void startPackage(H5Intent intent) throws JSONException {
        JSONObject data = new JSONObject();
        JSONObject param = intent.getParam();
